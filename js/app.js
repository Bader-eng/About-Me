...
function q1() {
  let question1 = prompt('guess my answer').toLowerCase();
...
//q1( question1 = prompt('Have I lived in hay nazzal my whole life?').toLowerCase());
...
q1( prompt('Is my favorite color yellow?').toLowerCase());
